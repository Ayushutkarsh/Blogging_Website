...
#In SQLAlchemy we can make classes inhereting from db.Model for required tables
...
class Post(db.Model):
    ...
    def __repr__(self):
        return "User('{title}','{date_posted}'".format(title=self.title, date_posted=self.date_posted)
