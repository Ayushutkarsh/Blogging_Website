...
#flask_login is used to manage logged in user. 
#current_user check whether an authenticated user is present
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password,form.password.data):
            ...
            flash('Login Denied. Please check your credentials','danger')
...
def user_posts(username):
    ...
    # we can use '\' to break long queries into multiple lines
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email with the reset link has been sent to your registered email account','info')
        return redirect(url_for('login'))
